<template>
    <div style="display: inline-block;height: 160mm;width: 150mm">
        ...
        <div id="data_specDtex" class="data" style="left: 50mm;top:36mm;width: 34mm">{{data.specDtex}}</div>
        <div id="text15" class="en" style="left: 86mm;top:44mm">dtex</div>
        <div id="data_specMm" class="data" style="left: 100mm;top:36mm;width: 32mm">{{data.specMm}}</div>
        ...
        <div id="data_grade" class="data" style="left: 52mm;top:57mm;width: 80mm">{{data.grade}}</div>

        <div id="text05" class="cn" style="left: 10mm;top:84mm">净重</div>
        <div id="text11" class="en" style="left: 30mm;top:87mm">Weight:</div>
        <div id="data_weight" class="data" style="left: 52mm;top:80mm;width: 80mm">{{data.weight.toFixed(1)}}</div>
        ...
        <div id="data_lotNo" class="data" style="left: 52mm;top:100mm;width: 80mm">{{data.lotNo}}</div>

        <div id="text07" class="cn" style="left: 10mm;top:124mm">包号</div>
        <div id="text13" class="en" style="left: 28mm;top:127mm">Bale No.:</div>
        <div id="data_baleNo" class="data" style="left: 52mm;top:120mm;width: 80mm">{{data.baleNo}}</div>
